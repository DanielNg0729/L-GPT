...
Companion to [`literature_review.md`](literature_review.md), which covers the task-level literature
...
decision these methods exist to optimize does not exist here. See
[`literature_review.md`](literature_review.md), section 6.
