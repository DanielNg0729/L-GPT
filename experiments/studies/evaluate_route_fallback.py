...
def main() -> None:
    dev = score(ROOT / "experiments" / "studies" / "route_shift" / "route_shift_development.jsonl")
    holdout = score(ROOT / "experiments" / "studies" / "route_shift" / "route_shift_holdout.jsonl")
