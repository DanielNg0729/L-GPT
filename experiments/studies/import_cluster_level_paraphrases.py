...
CLUSTERS = ROOT / "experiments" / "datasets" / "cluster_level_paraphrase_generation_input.jsonl"
INVENTORY = ROOT / "experiments" / "datasets" / "external_train_only_canonicals.jsonl"
OUT = ROOT / "experiments" / "datasets" / "cluster_level_paraphrases_train_only.jsonl"
