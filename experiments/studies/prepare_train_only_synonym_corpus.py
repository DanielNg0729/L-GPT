...
from experiments.studies.generate_catalogue_synonyms import banned_phrases, norm, valid
from experiments.studies.import_train_only_synonyms import valid_overlap_augmentation

ROOT = Path(__file__).resolve().parents[2]
GROQ = ROOT / "experiments" / "datasets" / "catalogue_synonym_training.jsonl"
EXTERNAL = ROOT / "experiments" / "datasets" / "catalogue_synonym_external_train_only.jsonl"
BROAD = ROOT / "experiments" / "datasets" / "catalogue_synonym_broad_semantic_train_only.jsonl"
OVERLAP = ROOT / "experiments" / "datasets" / "catalogue_synonym_broad_overlap_train_only.jsonl"
OUT = ROOT / "experiments" / "datasets" / "catalogue_synonym_train_only_merged.jsonl"
