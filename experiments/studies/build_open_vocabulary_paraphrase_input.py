...
Run:  PYTHONIOENCODING=utf-8 python -u experiments/studies/build_open_vocabulary_paraphrase_input.py
"""
...
def main() -> None:
    ...
    base = load_jsonl(ROOT / "experiments" / "datasets" / "sets" / "catalog_review_distinct_800.jsonl")
