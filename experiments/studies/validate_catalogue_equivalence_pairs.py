...
DEFAULT_INPUT = ROOT / "experiments" / "datasets" / "catalogue_equivalence_pairs_proposed.jsonl"
DEFAULT_OUTPUT = ROOT / "experiments" / "datasets" / "catalogue_equivalence_pairs_measurement_checked.jsonl"
