"""Experiment 37: harden the popularity prior against population shift.
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_37.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_37.json   {time.time()-t0:.0f}s")
