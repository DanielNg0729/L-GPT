"""Experiment 39: detect the target population WITHOUT ever reading a target.
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_39.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_39.json   {time.time()-t0:.0f}s")
