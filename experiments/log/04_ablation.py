"""
Experiment 4: ablation ladder, scored by the REAL evaluator.
...
if __name__ == "__main__":
    ...
    Path(ROOT / "experiments" / "results" / "out_04.json").write_text(json.dumps(slim, indent=2, default=str), encoding="utf-8")
    print("\n[saved] experiments/results/out_04.json")
