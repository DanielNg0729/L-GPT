"""
Experiment 17: everything not yet measured, including things previously rejected on reasoning alone.
...
Path(ROOT / "experiments" / "results" / "out_17.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] experiments/results/out_17.json")
