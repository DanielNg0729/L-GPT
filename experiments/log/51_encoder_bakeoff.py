"""Experiment 51: does a BETTER PRETRAINED ENCODER improve the scaffolding tagger?
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_51.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_51.json   {time.time()-t0:.0f}s")
