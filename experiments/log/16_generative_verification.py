"""
Experiment 16: generative verification -- inverting the data-generating function.
...
Path(ROOT / "experiments" / "results" / "out_16.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] experiments/results/out_16.json")
