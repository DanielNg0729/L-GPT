"""
Experiment 10: three STRUCTURAL retrieval changes (not parameter tuning).
...
Path(ROOT / "experiments" / "results" / "out_10.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] experiments/results/out_10.json")
