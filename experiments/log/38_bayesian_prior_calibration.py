"""Experiment 38: stop ASSUMING the popularity prior holds; MEASURE it during the run.
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_38.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_38.json   {time.time()-t0:.0f}s")
