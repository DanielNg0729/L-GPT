"""
Experiment 3: retrieval ceiling.
...
Path(ROOT / "experiments" / "results" / "out_03.json").write_text(json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n\n[saved] experiments/results/out_03.json")
