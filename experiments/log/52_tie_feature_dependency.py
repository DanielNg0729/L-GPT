"""Experiment 52: WHICH product features actually predict the target inside a tie?
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_52.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_52.json   {time.time()-t0:.0f}s")
