"""Experiment 49: B-a -- a BERT token-tagger for scaffolding, and MLM adaptation on the 50k corpus.
...
def main() -> None:
    ...
    def mlm_adapt():
        ...
        out = ROOT / "experiments" / "studies" / ".mlm_adapted"
    ...
    (ROOT / "experiments" / "results" / "out_49.json").write_text(
        json.dumps(RESULTS, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_49.json   {time.time()-t0:.0f}s")
