"""Experiment 33: the robustness benchmark found two constants tuned to the WRONG population.
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_33.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_33.json   {time.time()-t0:.0f}s")
