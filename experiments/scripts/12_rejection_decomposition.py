"""
Experiment 12: is rejection feedback's +0.0103 real, or is it the §8.5 metric artifact again?
...
Path(ROOT / "experiments" / "results" / "out_12.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] experiments/results/out_12.json")
