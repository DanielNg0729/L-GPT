"""Experiment 42: raise the OFFLINE paraphrase floor before betting on a network component.
...
chosen when mining was a fallback nobody had measured under stress. `docs/design/hyperparameters.md`
...
def main() -> None:
    ...
    (ROOT / "experiments" / "results" / "out_42.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] experiments/results/out_42.json   {time.time()-t0:.0f}s")
