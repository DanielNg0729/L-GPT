...
Companion documents: [`track4_brief.md`](track4_brief.md) (the official problem statement),
[`findings.md`](findings.md) (our empirical results), [`eda/`](eda/) (reproducible scripts).
...
difference is the whole argument of [`findings.md`](findings.md) §2.
...
> solves it. See [`findings.md`](findings.md) §5.
