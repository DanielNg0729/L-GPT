...
| 2 | **Message templates** (5 regexes) | +0.154 | +0.188 | **P1** | **O2** | Regexes match the generator's literal format strings in source. Population-free — but they simply stop firing under paraphrase. |
...
| 8 | **n-gram mining** (catalogue as dictionary) | **+0.0001** | −0.0008 | **P1** | **O1** | ⚠️ Reads as worthless. It is the most important robustness component in the system — see §3. |
