"""EDA pass 28: autopsy of the remaining HitRate misses.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/28_miss_autopsy.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_28.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_28.json")
