"""EDA pass 19: does an LLM break the ties the evidence cannot?
...
Usage:
  python notes/eda/19_llm_rerank.py --half tune  --online
  python notes/eda/19_llm_rerank.py --half hold  --online
  python notes/eda/19_llm_rerank.py --half tune  --online --model llama-3.3-70b-versatile
"""
...
def main() -> None:
    ...
    out = Path(args.output or f"notes/eda/out_19_{args.half}.json")
