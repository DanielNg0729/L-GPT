"""EDA pass 40: set the popularity prior from a DIRECTLY OBSERVED population statistic.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/40_detector_driven_prior.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_40.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_40.json   {time.time()-t0:.0f}s")
