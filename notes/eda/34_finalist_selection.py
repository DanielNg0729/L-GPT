"""EDA pass 34: pick the final configuration by WORST CASE across every stress axis.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/34_finalist_selection.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_34.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_34.json   {time.time()-t0:.0f}s")
