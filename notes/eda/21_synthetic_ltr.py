"""EDA pass 21: learning-to-rank on SYNTHETIC sessions minted from the known generator.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/21_synthetic_ltr.py --mint 12000
"""
...
def main() -> None:
    ...
    ap.add_argument("--cache", default="notes/eda/.ltr_feats.npz",
    ...
    cache_p = ROOT / "notes" / "eda" / ".ltr_feats.npz"
    if cache_p.exists():
        z = np.load(cache_p)
    ...
    (ROOT / "notes" / "eda" / "out_21.json").write_text(
        json.dumps(OUT, indent=2, default=str), encoding="utf-8")
    print("\n[saved] notes/eda/out_21.json")
