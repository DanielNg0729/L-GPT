"""EDA pass 53: on the ties popularity gets WRONG, does any other feature get them right?
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/53_complementary_signal.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_53.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_53.json   {time.time()-t0:.0f}s")
