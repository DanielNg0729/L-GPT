...
Run a small stratified pilot (default):
  python notes/eda/21_llm_extraction_robustness.py --online

Run the full official 200-session harness with LLM extraction only:
  python notes/eda/21_llm_extraction_robustness.py --online --all --levels exact
"""
...
_load_project_env()
CACHE = ROOT / "notes" / "eda" / ".llm_extraction_cache.json"
OUT = ROOT / "notes" / "eda" / "out_21_llm_extraction.json"
