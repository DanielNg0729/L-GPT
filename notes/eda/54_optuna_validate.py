"""EDA pass 54: validate the coarse study's candidates under the CORRECTED objective.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/54_optuna_validate.py --top 6
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_54.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_54.json   {time.time()-t0:.0f}s")
