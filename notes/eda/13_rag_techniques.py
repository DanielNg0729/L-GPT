"""
EDA pass 13: two RAG-family retrieval techniques that actually apply here.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/13_rag_techniques.py
"""
...
Path(ROOT / "notes" / "eda" / "out_13.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_13.json")
