"""
EDA pass 5: failure analysis, dense fusion, and robustness stress tests.
...
Run:  PYTHONIOENCODING=utf-8 python notes/eda/05_failure_dense_robustness.py
...
Path(ROOT / "notes" / "eda" / "out_05.json").write_text(json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_05.json")
