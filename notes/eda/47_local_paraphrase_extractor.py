"""EDA pass 47: M2 -- a LOCAL paraphrase-robust extractor, to replace the API call.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/47_local_paraphrase_extractor.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_47.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_47.json   {time.time()-t0:.0f}s")
