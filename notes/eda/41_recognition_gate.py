"""EDA pass 41: can we PROVE an LLM extraction channel never fires on clean messages?
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/41_recognition_gate.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_41.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_41.json")
