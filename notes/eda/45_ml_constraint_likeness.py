"""EDA pass 45: M1 -- a LEARNED constraint-likeness scorer for n-gram mining.

WHY THIS IS NOT ANOTHER DOOMED RANKING MODEL
--------------------------------------------
Thirteen learned approaches have been tried and rejected on this task (ml_lit_review.md
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/45_ml_constraint_likeness.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_45.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_45.json   {time.time()-t0:.0f}s")
