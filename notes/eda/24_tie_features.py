"""EDA pass 24: tie-specialised feature model with WITHIN-GROUP normalisation.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/24_tie_features.py
"""
...
def main() -> None:
    ...
    spec = importlib.util.spec_from_file_location(
        "p23", ROOT / "notes" / "eda" / "23_tie_crossencoder.py")
    ...
    (ROOT / "notes" / "eda" / "out_24.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_24.json")
