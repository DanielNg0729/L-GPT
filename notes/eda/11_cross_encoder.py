"""
EDA pass 11: cross-encoder reranking -- retracting a badly-argued decline.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/11_cross_encoder.py
"""
...
Path(ROOT / "notes" / "eda" / "out_11.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_11.json")
