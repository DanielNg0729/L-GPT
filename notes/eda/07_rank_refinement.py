"""
EDA pass 7: coordinate-ascent tuning of the reranker, scored by the official evaluator.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/07_rank_refinement.py
"""
...
Path(ROOT / "notes" / "eda" / "out_07.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_07.json")
