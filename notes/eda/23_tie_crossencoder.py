"""EDA pass 23: a cross-encoder FINE-TUNED on this task, specialised on tie decisions.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/23_tie_crossencoder.py --mint 12000
"""
...
GROUPS_CACHE = ROOT / "notes" / "eda" / ".tie_groups.pkl"
...
def main() -> None:
    ...
    out_dir = ROOT / "notes" / "eda" / "tie_ce_model"
    ...
    (ROOT / "notes" / "eda" / "out_23.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_23.json")
