"""
EDA pass 14: modelling the TARGET SELECTION PRIOR.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/14_target_prior.py
"""
...
Path(ROOT / "notes" / "eda" / "out_14.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_14.json")
