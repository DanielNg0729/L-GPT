"""
EDA pass 6: catalog-grounded evidence mining + information-ordered probing.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/06_grounded_mining.py
"""
...
Path(ROOT / "notes" / "eda" / "out_06.json").write_text(json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_06.json")
