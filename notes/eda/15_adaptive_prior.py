"""
EDA pass 15: turn-adaptive prior weighting.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/15_adaptive_prior.py
"""
...
try:
    prev = json.loads((ROOT / "notes" / "eda" / "out_14.json").read_text(encoding="utf-8"))
...
Path(ROOT / "notes" / "eda" / "out_15.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_15.json")
