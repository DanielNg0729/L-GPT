"""EDA pass 27: B2 + B4 -- learned retrieval, re-motivated by the width-1 objective.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/27_learned_retrieval.py --mint 8000
"""
...
W1 = (1,) * 9 + (10,)
PAIRS_CACHE = ROOT / "notes" / "eda" / ".retr_pairs.pkl"
...
def main() -> None:
    ...
    try:
        ...
        (ROOT / "notes" / "eda" / "out_27.json").write_text(
