"""EDA pass 36: adjudicate a grading disagreement between two independent robustness audits.

An independently-run benchmark (notes/robustness_benchmark.md) graded SEQUENTIAL DISCLOSURE
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/36_disclosure_risk_adjudication.py
"""
