"""
EDA pass 9: disclosure policy and rejection feedback -- two STRUCTURAL changes, not tuning.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/09_disclosure_policy.py
"""
...
Path(ROOT / "notes" / "eda" / "out_09.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_09.json")
