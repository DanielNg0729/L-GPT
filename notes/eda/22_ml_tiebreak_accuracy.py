"""EDA pass 22: is the ML model better than popularity INSIDE ties? The decisive test.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/22_ml_tiebreak_accuracy.py
"""
...
CACHE = ROOT / "notes" / "eda" / ".ltr_feats.npz"
if not CACHE.exists():
...
spec = importlib.util.spec_from_file_location("p21", ROOT / "notes" / "eda" / "21_synthetic_ltr.py")
...
(ROOT / "notes" / "eda" / "out_22.json").write_text(
    json.dumps(out, indent=2) + "\n", encoding="utf-8")
print("\n[saved] notes/eda/out_22.json")
