"""EDA pass 25: solve the optimal disclosure width instead of guessing it.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/25_disclosure_policy_solver.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_25.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_25.json")
