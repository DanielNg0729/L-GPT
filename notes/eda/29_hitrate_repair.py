"""EDA pass 29: repair the two HitRate misses -- and prove the fixes are not 2-session overfits.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/29_hitrate_repair.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_29.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_29.json")
