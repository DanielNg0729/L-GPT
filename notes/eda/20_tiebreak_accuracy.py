"""EDA pass 20: can the LLM actually break these ties? Measured directly.
...
Usage:
  PYTHONIOENCODING=utf-8 LLM_RERANK=1 python -u notes/eda/20_tiebreak_accuracy.py --half tune
"""
...
def main() -> None:
    ...
    p = ROOT / "notes" / "eda" / f"out_20_{args.half}.json"
