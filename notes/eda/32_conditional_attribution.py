"""EDA pass 32: two questions that passes 30 and 31 raised but could not answer alone.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/32_conditional_attribution.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_32.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_32.json   {time.time()-t0:.0f}s")
