"""
EDA pass 2: the simulator's total information budget, and the dominance of ask_attribute='other'.
...
Run:  PYTHONIOENCODING=utf-8 python notes/eda/02_information_budget.py
"""
...
Path(ROOT / "notes" / "eda" / "out_02.json").write_text(json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n\n[saved] notes/eda/out_02.json")
