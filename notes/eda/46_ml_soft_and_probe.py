"""EDA pass 46: M1 used SOFTLY, and M2 -- a learned state-conditioned probe policy.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/46_ml_soft_and_probe.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_46.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_46.json   {time.time()-t0:.0f}s")
