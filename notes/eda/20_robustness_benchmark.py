...
* Organiser uncertainty: documented counterfactuals from EDA passes 05 and 06
...
Run: python notes/eda/20_robustness_benchmark.py
"""
...
OUT_JSON = ROOT / "notes" / "eda" / "out_20_robustness.json"
OUT_MD = ROOT / "notes" / "robustness_benchmark.md"
