"""EDA pass 43: measure the three-way hybrid -- templates + mining + gated LLM extraction.
...
Run:  PYTHONIOENCODING=utf-8 LLM_EXTRACT=1 python -u notes/eda/43_llm_extraction_hybrid.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_43.json").write_text(
        json.dumps(OUT, indent=2, default=str) + "\n", encoding="utf-8")
    print(f"\n[saved] notes/eda/out_43.json   {time.time()-t0:.0f}s")
