"""
EDA pass 18: learning-to-rank over the coverage features.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/18_learning_to_rank.py
"""
...
Path(ROOT / "notes" / "eda" / "out_18.json").write_text(
    json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print("\n[saved] notes/eda/out_18.json")
