"""EDA pass 26: validate disclosure schedules tune/held-out, and test an ADAPTIVE policy.
...
Run:  PYTHONIOENCODING=utf-8 python -u notes/eda/26_disclosure_validate.py
"""
...
def main() -> None:
    ...
    (ROOT / "notes" / "eda" / "out_26.json").write_text(
        json.dumps(OUT, indent=2) + "\n", encoding="utf-8")
    print("\n[saved] notes/eda/out_26.json")
