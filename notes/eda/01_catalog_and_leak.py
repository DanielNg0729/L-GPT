"""
EDA pass 1: catalog structure + reverse-engineering the simulator's information channel.
...
Run:  python notes/eda/01_catalog_and_leak.py
"""
...
Path(ROOT / "notes" / "eda" / "out_01.json").write_text(json.dumps(OUT, indent=2, default=str), encoding="utf-8")
print(f"\n\n[saved] notes/eda/out_01.json")
