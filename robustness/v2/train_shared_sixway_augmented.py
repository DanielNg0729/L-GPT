...
ROOT=Path(__file__).resolve().parents[2]; TRAIN=ROOT/'robustness/v2/v1_route_template_bank/train.jsonl'; AUG=ROOT/'robustness/v2/route_phrase_augmentation.jsonl'; EVAL=ROOT/'robustness/v2/v1_route_template_bank/test.jsonl'; BASE=ROOT/'submission/models/scaffolding_tagger'; OUT=ROOT/'robustness/v2/results/shared_sixway_phrase_augmented_eval.json'; MODEL=ROOT/'.v2_model_cache/shared_sixway_phrase_augmented_cuda'; LABELS=('buying_opening','constraint_update','no_evidence','override_opening','override_update','plain_opening'); OPEN={'buying_opening','plain_opening','override_opening'}; SEED=20260831
