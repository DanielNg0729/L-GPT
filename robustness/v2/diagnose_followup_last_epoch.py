...
TRAIN_SPLIT = ROOT / "robustness" / "v2" / "v1_route_template_bank" / "train.jsonl"
EVAL_SPLIT = ROOT / "robustness" / "v2" / "v1_route_template_bank" / "test.jsonl"
TEST_SPLIT = ROOT / "robustness" / "v2" / "v1_turn_gated_bank" / "final_test.jsonl"
BASE = ROOT / "submission" / "models" / "scaffolding_tagger"
MODEL_OUT = ROOT / ".v2_model_cache" / "v1_turn_gated_followup_last_epoch_cuda"
OUT = ROOT / "robustness" / "v2" / "results" / "v1_turn_gated_followup_last_epoch_diagnostic.json"
