...
from robustness.v2.pretrained_attribute_baseline import MODEL, load_model, read_jsonl

ROOT = Path(__file__).resolve().parents[2]
DATA = ROOT / "robustness" / "v2" / "sets" / "frozen_equivalence_verification.jsonl"
OUT = ROOT / "robustness" / "v2" / "results" / "pretrained_equivalence_baseline.json"
