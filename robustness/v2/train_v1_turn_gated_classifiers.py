...
TRAIN = ROOT / "robustness" / "v2" / "v1_route_template_bank" / "train.jsonl"
DEVELOPMENT = ROOT / "robustness" / "v2" / "v1_route_template_bank" / "test.jsonl"
FINAL = ROOT / "robustness" / "v2" / "v1_turn_gated_bank" / "final_test.jsonl"
BASE = ROOT / "submission" / "models" / "scaffolding_tagger"
MODEL_ROOT = ROOT / ".v2_model_cache"
OUT = ROOT / "robustness" / "v2" / "results" / "v1_turn_gated_classifiers_cuda.json"
SEED = 20260829
GROUPS = {
