...
ROOT=Path(__file__).resolve().parents[2]; DATA=ROOT/"robustness"/"v2"/"v1_route_actions"; BASE=ROOT/"submission"/"models"/"scaffolding_tagger"; OUT=ROOT/"robustness"/"v2"/"results"/"v1_route_action_classifier_seeded.json"; MODEL_OUT=ROOT/".v2_model_cache"/"v1_route_action_classifier_seeded"; SEED=20260906
