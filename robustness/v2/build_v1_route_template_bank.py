...
ROOT=Path(__file__).resolve().parents[2]; SOURCE=ROOT/"robustness"/"v2"/"sets"/"semantic_attribute_development_200.jsonl"; PUBLIC=ROOT/"data"/"public_set.jsonl"; CATALOG=ROOT/"data"/"catalog.jsonl"; OUT=ROOT/"robustness"/"v2"/"v1_route_template_bank"
