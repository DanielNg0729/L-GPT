...
from robustness.v2.generate_catalogue_synonyms import banned_phrases, norm, shares_ngram, valid

ROOT = Path(__file__).resolve().parents[2]
DICTIONARY = ROOT / "robustness" / "v2" / "catalogue_attribute_dictionary.jsonl"
DEFAULT_OUTPUT = ROOT / "robustness" / "v2" / "catalogue_synonym_external_train_only.jsonl"
