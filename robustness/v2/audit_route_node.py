...
from robustness.v2.run_semantic_attribute import v2_behavior, v2_customer_reply, v2_initial_message

ROOT = Path(__file__).resolve().parents[2]
DATASET = ROOT / "robustness" / "v2" / "sets" / "semantic_attribute_development_200.jsonl"
OUT = ROOT / "robustness" / "v2" / "results" / "route_node_development.json"
