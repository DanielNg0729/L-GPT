...
ROOT=Path(__file__).resolve().parents[2]; TEST=ROOT/'robustness/v2/v1_turn_gated_bank/final_test.jsonl'; MODEL=ROOT/'.v2_model_cache/shared_sixway_phrase_augmented_cuda'; OUT=ROOT/'robustness/v2/results/shared_sixway_phrase_augmented_test.json'; LABELS=('buying_opening','constraint_update','no_evidence','override_opening','override_update','plain_opening'); OPEN={'buying_opening','plain_opening','override_opening'}
def main():
